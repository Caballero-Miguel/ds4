<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Laboratorio_16._1.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div class="cal">
            <!-- Cambie ID a "Uno", Para corregir Conflictos-->
            <asp:Label ID="Uno" Text=" CALCULADORA BASICA" runat="server" Style="margin-left: 50px" 
